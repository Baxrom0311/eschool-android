...
void main() {
  ...
  group('MenuApi', () {
    ...
    test('getDailyMenu parses meals_by_child properly', () async {
      ...
      // Act
      final result = await menuApi.getDailyMenu(
        date: tDate,
      ...
      final breakfast = result.firstWhere(
    ...
    test('getDailyMenu localizes group label in descriptions', () async {
      ...
      expect(
        result.first.dishes.first.description,
        'Group: A1\nBoil for 5 mins',
      );
    });
  });
