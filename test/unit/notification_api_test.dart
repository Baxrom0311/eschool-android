...
void main() {
  ...
  group('NotificationApi', () {
    ...
    test(
      'getNotifications returns list of NotificationModel on success',
      () async {
        // Arrange
        final tResponse = {
          'notifications': [
    ...
    test('markAsRead executes successfully', () async {
      ...
      when(
        ...
        (_) async => Response(
          requestOptions: RequestOptions(
            path: ApiConstants.markAsRead(tNotificationId),
          ),
          statusCode: 200,
        ),
      );
      ...
      // Assert
      verify(
        () => mockDioClient.post(ApiConstants.markAsRead(tNotificationId)),
      ).called(1);
    });
