...
void main() {
  ...
  setUp(() async {
    ...
    when(
      () => mockNotificationApi.getNotifications(page: any(named: 'page')),
    ).thenAnswer((_) async => []);
    when(
  ...
  group('HomeScreen Widget Tests', () {
    testWidgets(
      'HomeScreen renders bottom navigation and dashboard aggregations',
      (WidgetTester tester) async {
        ...
        expect(
          find.text('Davomat'),
          findsWidgets,
        ); // AttendanceCard usually shows it
        expect(
          find.text('O\'rtacha baho'),
          findsWidgets,
        ); // AcademicStats usually shows GPA logic
        expect(
          find.text('Bugungi darslar'),
          findsWidgets,
        ); // Schedule list title
